/* @ts-self-types="./laya_inference.d.ts" */
...
export class LayaWasm {
    static __wrap(ptr) {
        const obj = Object.create(LayaWasm.prototype);
        obj.__wbg_ptr = ptr;
        LayaWasmFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        LayaWasmFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_layawasm_free(ptr, 0);
    }
    /**
     ...
     */
    cache_size() {
        const ret = wasm.layawasm_cache_size(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * Run one inference.
    ...
    static load(bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.layawasm_load(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return LayaWasm.__wrap(ret[0]);
    }
}
if (Symbol.dispose) LayaWasm.prototype[Symbol.dispose] = LayaWasm.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./laya_inference_bg.js": import0,
    };
}

const LayaWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_layawasm_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('laya_inference_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
